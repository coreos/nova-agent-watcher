...
import (
	"github.com/coreos/nova-agent-watcher/Godeps/_workspace/src/github.com/guelfey/go.dbus"
	"github.com/coreos/nova-agent-watcher/Godeps/_workspace/src/github.com/guelfey/go.dbus/introspect"
	"sync"
)
